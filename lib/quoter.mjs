...
export class ExactQuoter {
  constructor(opts = {}) {
    this.opts = { maxAgeMs: 3000, live: false, clock: null, dynamicFees: true, creatorFees: true,
  ...
  #quote(addr, inputMint, amountIn) {
    ...
    if (venue === 'Raydium CP') {
      ...
      r0 -= t.cf0; r1 -= t.cf1;
      if (r0 <= 0n || r1 <= 0n) return { ok: false, reason: 'empty reserves' };
      /* creatorFees: false isolates the per-swap creator fee for an A/B (accrued fees still leave the reserves). */
      const creatorMicro = this.opts.creatorFees ? t.creatorMicro : 0n;
      return { ok: true, venue, crossed: 0,
        out: cpExactInCreator(inIs0 ? r0 : r1, inIs0 ? r1 : r0, amt, micro, creatorMicro, t.onInput) };
    }
